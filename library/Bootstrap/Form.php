...
class Bootstrap_Form extends Zend_Form
{
    ...
    protected function setDisplayForm($displayFormVal){
        $this->displayForm = $displayFormVal;
        var_dump("setDisplayForm");
    }
	public function __construct($options = null)
	{
		// Let's load our own decorators
		$this->addPrefixPath("Bootstrap_Form_Decorator", "Bootstrap/Form/Decorator/", "decorator");
	...
	protected function _getElementDecorators()
	{
		return array(
			...
			array(array("innerwrapper" => "HtmlTag"), array("tag" => "div", "class" => "col-md-7")),
			array("Label", array("class" => "control-label col-md-3 col-sm-3 col-xs-12")),
	...
	public function addElement($element, $name = null, $options = null)
	{
		...
		if($element instanceof Zend_Form_Element_Text || $element instanceof Zend_Form_Element_Select)
		{
                    $element->setAttrib("class", trim("form-control " . $element->getAttrib("class")));
		}
		if($element instanceof Zend_Form_Element_Text || $element instanceof Zend_Form_Element_Select)
		{
                    $element->setAttrib("class", trim("col-md-7 col-xs-1 " . $element->getAttrib("class")));
		}
		...
		if($element instanceof Zend_Form_Element_Checkbox)
		{
			$element->setDecorators(array(
				...
				array("Errors", array("placement" => "append")),
				array("Description", array("tag" => "span", "class" => "help-block")),
				array(array("innerwrapper" => "HtmlTag"), array("tag" => "div", "class" => "col-md-6 col-sm-6 col-xs-12")),
				array(array("outerwrapper" => "HtmlTag"), array("tag" => "div", "class" => "form-group"))
			));
		}
        ...
        $formTypes = array( // avaible form types of Twitter Bootstrap form (i.e. classes)
          ...
          'search'
            ...
            if(true !== $set) { // if neither type was set, we set the default vertical class
                $this->addDecorator("Form", array("class" => "form-horizontal form-label-left"));
            }
